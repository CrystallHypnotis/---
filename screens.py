...
def start_screen(width, height, fps):
    ...
    StartButton(buttons, pos=(width // 2, height // 4), sprite="picts/start_b_proj.png", size=(256, 30))
    QuitButton(buttons, pos=(width // 2, height // 4 + 150), sprite="picts/quit_b_proj.png", size=(83, 33))
    Title(titles, pos=(width // 2, height // 4 + 50), slides_and_sizes=[["picts/difficulty_t_proj.png", (233, 30)]])
    Title(titles, pos=(width // 2, height // 4 + 100), slides_and_sizes=[["picts/normal_menu_proj.png", (123, 30)],
                                                                         ["picts/hard_menu_proj.png", (123, 30)],
                                                                         ["picts/pain_menu_proj.png", (123, 30)]])

    LeftArrow(buttons, pos=(width // 2 - 100, height // 4 + 100),
              sprite="picts/left_arrow_menu.png", size=(31, 30))
    RightArrow(buttons, pos=(width // 2 + 100, height // 4 + 100),
               sprite="picts/right_arrow_menu.png", size=(31, 30))
    while running:
        clock.tick(fps)
...
def death_screen(width, height, fps, screen, score):
    ...
    RetryButton(buttons, pos=(width // 2, height // 4 + 150), sprite="picts/retry_b_proj.png", size=(128, 30))
    QuitButton(buttons, pos=(width // 2, height // 4 + 200), sprite="picts/quit_b_proj.png", size=(83, 33))
    Title(titles, pos=(width // 2, height // 4), slides_and_sizes=[["picts/you_died_t_proj.png", (410, 60)]])
    Title(titles, pos=(width // 2 - 100, height // 4 + 100), slides_and_sizes=[["picts/score_t_proj.png", (123, 30)]])
